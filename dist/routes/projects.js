...
router.route("/get-project/:projectId").get(verify_1.verifyOwner, projects_1.getProjectById);
router.route("/update-project/:projectId").post(verify_1.verifyOwner, projects_1.updateProject);
